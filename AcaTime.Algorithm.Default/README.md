# Алгоритм складання розкладу AcaTime.Algorithm.Default
...
1. **Температурна модель вибору**  
   При виборі змінної xᵢ та значення dᵢⱼ використовується функція розподілу ймовірностей:
...
1. **Незалежні траєкторії пошуку**
   - Запуск N незалежних екземплярів алгоритму з різними параметрами стохастичності
   - Кожний екземпляр досліджує різні частини простору розв'язків
