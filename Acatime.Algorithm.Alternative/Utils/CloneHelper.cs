...
namespace AcaTime.Algorithm.Alternative.Utils
{
    /// <summary>
    ...
    public static class CloneHelper
    {
        ...
        /// <returns></returns>
        public static AlternativeScheduleAlgorithmUnit Clone(this AlternativeScheduleAlgorithmUnit source)
        {
            ...
            var res = new AlternativeScheduleAlgorithmUnit();
